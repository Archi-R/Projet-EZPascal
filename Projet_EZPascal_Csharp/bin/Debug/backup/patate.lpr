program patate;        //nom de votre programme
{
...
Begin 
writeln('Tapez le numero de votre exercice que vous voulez executer(de 1 a 5):');
  ...
  case numeroEx of
       ...
       3:
         ...
         4:
           ...
           end;                  //end de fin de sousNum 4

         5:
           begin

           end;                  //end de fin de sousNum 5
